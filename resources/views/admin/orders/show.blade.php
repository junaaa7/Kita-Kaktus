...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="border-t pt-4">
            <label class="block text-gray-700 text-sm font-bold mb-2">Update Status Pesanan</label>
            <form action="{{ route('admin.orders.update-status', $order) }}" method="POST" class="flex space-x-2">
                @csrf
                @method('PUT')
                <select name="status" class="px-3 py-2 border border-gray-300 rounded-lg flex-1">
