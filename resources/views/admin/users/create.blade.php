...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Tambah Admin Baru</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-1">Buat akun admin baru untuk mengelola sistem</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <!-- Hidden input untuk role admin (otomatis menjadi admin) -->
